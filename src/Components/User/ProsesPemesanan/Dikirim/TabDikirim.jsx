                      ...
                      <>
                       {
                         ...
                         <p style={{color:'#213360', fontSize:'20px', fontWeight:'700', margin:'0px 0px 10px'}}>Oops, pesanan belum ada yang dikiirm</p>
                         <p style={{color:'#8f939e', fontSize:'14px', margin:'0px 0px 30px'}}>Silahkan kembali berbelanja atau menunggu terlebih dahulu</p>
                     </div>
                       }
                      </>
                    }
