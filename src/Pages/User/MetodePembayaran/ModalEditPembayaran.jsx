...
const ModalEditPembayaran = (props) => {
    ...
    return (
        <>
         <div type="button"  onClick={() => setModalOpen(true)}  className="button-edit-rekening">
            Edit
        </div>
         <Modal className="box-modal-edit-pembayaran"  toggle={() => setModalOpen(false)} isOpen={modalOpen}>
            <ModalBody>
                ...
                <div className='judul-edit-metode-pembayaran'>Edit Metode Pembayaran</div>
                </div>
