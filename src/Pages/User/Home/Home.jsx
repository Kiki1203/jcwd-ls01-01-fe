...
const Home = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`${API_URL}/product/homeproduk`)
      .then((res) => {
        setLoading(false);
  ...
  useEffect(() => {
    ...
    axios
      .get(`${API_URL}/user/checkuserverify`, headers)
      .then((res) => {
        setLoading(false);
          ...
          <div className="product-card-home-2 mx-2">
            ...
            <div id="box-data-produk-home" onClick={() => navigate(`/productdetail/${value.id}`)}>
              ...
              <div id="box-harga-home" style={{ display: 'flex' }}>
                ...
                <span className="product-unit-home" style={{ marginLeft: '2px' }}>
                  {value.satuan_obat}
                </span>
              </div>
            </div>
    ...
    return (
      <div>
        ...
        <div id="container-home">
          {loading ? (
            <>
              <div className="box-loading-profile">'Loading ...'</div>
            </>
          ) : (
            <>
              <div>
                ...
                <div className="inside-container-home-2">
                  ...
                  <div className="box-unggah-resep">
                    ...
                    <div className="d-lg-block d-md-block d-none">
                      ...
                      {!localStorage.getItem('myTkn') ? (
                        <button className="btn-unggah-resep" onClick={() => navigate('/login')}>
                          Unggah Resep
                        </button>
                      ) : (
                        <button className="btn-unggah-resep" onClick={() => navigate('/uploadresep')}>
                          Unggah Resep
                        </button>
                      )}
                    </div>
                ...
                <div className="inside-container-home-4">
                  ...
                  <div className="d-flex">
                    ...
                    <div className="box-isi-card-home">
                      <div className="box-isi-card-home-2">{printData()}</div>
                    </div>
                  </div>
                </div>
                <hr />
                ...
                <div className="inside-container-home-6">
                  <div className="box-tulisan-6">
                    ...
                    <div className="box-3-jumbotron">
                      <div className="box-3-jumbotron-2">{printData2()}</div>
                    </div>
                  </div>
                </div>
                <hr />
